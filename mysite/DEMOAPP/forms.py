...
class SignUpForm(UserCreationForm):
    email = forms.EmailField(label="", widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Enter valid email address'}))
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password1'].help_text = '<small><ul><li>Your password can\'t be too similar to your other personal information.</li>' \
